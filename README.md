...
建议 Mac 与 iPad 版本保存在同一个仓库。两端共享品牌、模板结构和相机工作流程，单一仓库更容易保持同步。可在 GitHub Releases 中分别提供 Mac 版说明和 iPad 版安装说明。

上传前请确认：

- 不提交私人活动照片、打印成片或个人资料。
- App Icon、字体及模板图片拥有公开发布权限。
- 如希望其他人修改或分发代码，请在仓库中加入合适的 `LICENSE`。
